...
public class Nrrd_Writer implements PlugIn {
	...
	boolean compN=(boolean)Prefs.get("compN.boolean",false);
	...
	public void run(String arg) {
		...
		GenericDialog gd = new GenericDialog("Saving option");
		gd.addCheckbox("Compressed Nrrd",compN);
		gd.showDialog();
		if(gd.wasCanceled()){
			return;
		}
		compN = gd.getNextBoolean();
		Prefs.set("compN.boolean",compN);
