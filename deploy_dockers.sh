...
singularity build -F /tmp/out.sif docker://registry.int.janelia.org/jacs-scripts/flylight_perl:1.0.0
cp /tmp/out.sif $JACS_SINGULARITY_DIR/flylight_perl-1.0.0.img
